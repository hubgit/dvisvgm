...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('dvisvgm.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('dvisvgm.wasm', import.meta.url).href;
...
var findStringEnd = (heapOrArray, idx, maxBytesToRead, ignoreNul) => {
  ...
  function _kpse_load_file_remote(namePtr, format) {
...
var wasmImports = {
  ...
  invoke_viiii,
  /** @export */
  kpse_load_file_remote: _kpse_load_file_remote,
  /** @export */
